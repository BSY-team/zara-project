...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const res = await fetch('http://localhost:5000/product/OneProduct/' + oneID);
  const data = await res.json();
